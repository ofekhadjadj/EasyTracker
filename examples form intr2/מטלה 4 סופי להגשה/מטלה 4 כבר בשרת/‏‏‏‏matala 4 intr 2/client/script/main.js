...
const GetGamesApi = `https://proj.ruppin.ac.il/igroup4/test2/tar1/api/Games/GetGamesNotLinkedToUser/${userOBJ[0].id}`;
    ...
    if (e.target.tagName === "BUTTON") {
      data.forEach((game) => {
        if (game.appID == e.target.id) {
          ...
          const api = `https://proj.ruppin.ac.il/igroup4/test2/tar1/api/UserGame/userID/${userOBJ[0].id}/gameID/${GameToPost.appID}`;
