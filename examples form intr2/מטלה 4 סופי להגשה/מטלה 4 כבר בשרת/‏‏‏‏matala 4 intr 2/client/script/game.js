const GAME = [
  ...
  },
  {
    ...
    Price: 11.99,
    description:
      "Â«DupioÂ» â€” is a fast and challenging non-stop arcade, with minimalistic gameplay. You must play contemporaneously both hands. The game has two screens with purple main characters. The right character is controlled by the mouse.The left hero controlled by keyboard. Avoid red spikes and collect the green circles, survive as long as possible and break your own record. |CONTROL OF THE RIGHT HERO| â— Mouse |CONTROL OF THE LEFT HERO| â— [W] - Move Up â— [S] - Move Down â— [D] - Move Right â— [A] - Move Left produced by",
    Full_audio_languages: "['English']",
    Header_image:
