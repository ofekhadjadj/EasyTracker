...
const GetUsersApi = `https://proj.ruppin.ac.il/igroup4/test2/tar1/api/Users/GetUsersWithGameStats
`;
...
userstbl.addEventListener("click", (e) => {
  if (e.target.tagName === "INPUT" && e.target.type === "checkbox") {
    ...
    let SetActiveUrl = `https://proj.ruppin.ac.il/igroup4/test2/tar1/api/Users/userID/${e.target.id}/isActive/${isChecked}`;
...
const GetGamesApi = `https://proj.ruppin.ac.il/igroup4/test2/tar1/api/Games/GetGamesWithStats`;
