...
('תכנון', '#3357FF', 1, 0),
('עיצוב', '#FF33A1', 1, 0),
('שיחה עם לקוח', '#FFFF33', 1, 0),
('המתנה לאישור', '#33FFFF', 1, 0),
('תיקונים', '#FF9933', 1, 0),
('בדיקת קוד', '#9999FF', 1, 0),
('תיעוד', '#FF6666', 1, 0),
('העלאה לשרת', '#66FF66', 1, 0),
('ישיבת צוות', '#6666FF', 1, 0),
('רעיונות', '#FF66FF', 1, 0),
('תחזוקה', '#33CC99', 1, 0),
('UX/UI', '#9966CC', 1, 0),
('משימות שוטפות', '#CCFF66', 1, 0),
('אינטגרציה', '#FFCC99', 1, 0),
('חקר טכנולוגי', '#FFCCCC', 1, 0),
('סקר שוק', '#66CCFF', 1, 0),
('פגישה', '#99FF99', 1, 0),
('ללא תגית', '#CCCCCC', 1, 0);
